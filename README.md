...
**Segmento Pacientes: Entrevistado 1**
...
| **Timing**              | 21:52 - 30:32                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Video**               | [https://goo.su/8EMwBnI](https://goo.su/8EMwBnI)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Captura**             | ![Captura entrevista Bianca](assets/images/screenshots/validation-gabriel-interview-screenshot.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
Las entrevistas se realizaron entre el 9 y el 16 de abril de 2026, involucrando a nueve participantes clave (tres administradores, tres fisioterapeutas y tres pacientes) en Lima. El objetivo fue mapear el flujo de trabajo actual, identificar los puntos críticos de dolor y validar la propuesta de valor de *Uflex* centrada en la tele-rehabilitación monitorizada.

---

**Segmento: Administradores de clínicas**

**Características objetivas:**
* Uso de métodos analógicos (papel, Excel, cuadernos): **3/3 (100%)**
* Ausencia de sistemas integrados para seguimiento remoto: **3/3 (100%)**
* Volumen operativo superior a 180 pacientes mensuales: **3/3 (100%)**

**Características subjetivas:**
* Perciben el abandono del tratamiento (20-25%) como su mayor crisis financiera: **3/3 (100%)**
* Frustración por falta de métricas de productividad del personal: **3/3 (100%)**
* Disposición a invertir en tecnología si garantiza retención y eficiencia: **3/3 (100%)**
* Priorizan facilidad de uso y resistencia del hardware sobre funciones complejas: **3/3 (100%)**
...
**Características objetivas:**
* Dependencia de comunicación informal (WhatsApp) y memoria para seguimiento: **3/3 (100%)**
* Entornos clínicos de alta rotación con tiempo limitado por paciente: **3/3 (100%)**
* Ausencia de datos biomecánicos (ángulos, repeticiones) del trabajo en casa: **3/3 (100%)**

**Características subjetivas:**
* Sensación de trabajar "a ciegas" entre sesiones presenciales: **3/3 (100%)**
* Motivación alta por corregir pacientes en tiempo real para evitar lesiones: **3/3 (100%)**
* Rechazo a herramientas digitales que interrumpan el flujo clínico acelerado: **3/3 (100%)**
* Valoran la tele-rehabilitación como un medio para evitar recaídas y costos mayores: **2/3 (66%)**

---

**Segmento: Pacientes en rehabilitación**

**Características objetivas:**
* Uso intensivo de dispositivos móviles (celulares) en su día a día: **3/3 (100%)**
* Realizan ejercicios en casa sin supervisión técnica presencial: **3/3 (100%)**
* Inseguridad constante sobre si la ejecución técnica es correcta: **3/3 (100%)**

**Características subjetivas:**
* Sensación de estancamiento por falta de feedback objetivo: **3/3 (100%)**
* Alta disposición a usar tecnología si garantiza precisión y seguridad: **3/3 (100%)**
* El factor determinante para la adopción es la autonomía (colocación sin ayuda): **3/3 (100%)**
* Escepticismo ante soluciones que no ofrecen exactitud comprobable: **2/3 (66%)**

---

Tras analizar la interrelación de las entrevistas, se han identificado tres pilares críticos que justifican el desarrollo de *Uflex*:

1. **La brecha de datos como causa de abandono:** Existe una correlación directa entre la falta de supervisión técnica en casa (pacientes), la carencia de métricas objetivas (fisioterapeutas) y la tasa de deserción (administradores). Los pacientes abandonan porque se sienten estancados, los fisioterapeutas no pueden intervenir porque no ven el error, y los administradores pierden ingresos porque el ciclo terapéutico no se cierra. *Uflex* rompe este círculo vicioso mediante la telemetría.

2. **Validación de la propuesta de valor según segmento:**
    * **Para el Administrador:** *Uflex* no es un gasto, es una herramienta de retención y un elemento diferenciador (servicio "premium").
    * **Para el Fisioterapeuta:** *Uflex* no es una carga administrativa, es un aliado que permite el monitoreo proactivo sin necesidad de horas extra de supervisión.
    * **Para el Paciente:** *Uflex* no es un dispositivo complejo, es un "guía" personal que le devuelve la confianza y la seguridad necesaria para sanar.

3. **Criterios técnicos innegociables:**
    * **Usabilidad:** Cualquier interfaz debe ser "cero fricción". Tanto fisioterapeutas como administradores coinciden en que una herramienta compleja será descartada por el ritmo acelerado del entorno clínico.
    * **Autonomía:** El paciente, especialmente aquel que vive solo o busca independencia, requiere un hardware fácil de poner sin asistencia externa.
    * **Integración:** La solución debe ser un ecosistema que conecte la ejecución en casa con el reporte clínico en la clínica, eliminando el uso de mensajería informal (WhatsApp) como canal de registro técnico.

**Conclusión:**
Los resultados validan la necesidad de *Uflex*. El problema no es la falta de voluntad de rehabilitación, sino la falta de **tecnología de supervisión no invasiva**. La solución debe enfocarse en traducir datos biomecánicos complejos a alertas accionables y simples para el fisioterapeuta, asegurando así que el paciente reciba el acompañamiento necesario para completar su recuperación al 100%.
...
| **Sexo**                | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Distrito**            | San Borja                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **Ocupación**           | Administrador de clínica                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| **Timing**              | 00:00:00 - 00:15:47                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                                                                                                                                                                          |
| **Captura**             | ![Captura entrevista Carlos](assets/images/screenshots/clinic-admin-interview-screenshot-4.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Resumen**             | Carlos Vega comentó que la Landing Page le pareció atractiva, llamativa y con una presentación profesional. Destacó que la información se encuentra bien estructurada y que es suficiente para comprender la propuesta de valor y los planes ofrecidos. En cuanto a la Aplicación Web, indicó que el proceso de registro, inicio de sesión y selección del plan de suscripción es fácil de seguir, además de considerar que los planes son flexibles. Valoró positivamente la estructura visual, el cambio de idioma, el modo oscuro y la centralización de dispositivos, ejercicios y terapias en una sola plataforma. |

##### Entrevista 2: Alejandro Torres
...
| **Sexo**                | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Distrito**            | Miraflores                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Ocupación**           | Administrador de centro de rehabilitación                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Timing**              | 00:15:47 - 00:39:32                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                                                                                                                                       |
| **Captura**             | ![Captura entrevista Alejandro](assets/images/screenshots/validation-patient-interview-screenshot-1.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Resumen**             | Alejandro Torres evaluó positivamente el ecosistema de uFlex, destacando que la Landing Page y la Aplicación Web son intuitivas, fluidas y organizadas. También valoró los ejemplos en los campos de registro, el diseño directo y la inclusión del modo oscuro para reducir el cansancio visual. Como principales recomendaciones, sugirió hacer obligatoria la foto de perfil del fisioterapeuta para reforzar el profesionalismo, ampliar el catálogo de ejercicios hacia más partes del cuerpo y explicar mejor términos técnicos como firmware para usuarios no especializados. |

##### Entrevista 3: Roberto Jiménez
...
| **Sexo**                | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Distrito**            | Surco                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| **Ocupación**           | Administrador de clínica privada                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| **Timing**              | 00:39:33 - 01:01:13                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                                                                            |
| **Captura**             | ![Captura entrevista Roberto](assets/images/screenshots/validation-patient-interview-screenshot-2.png)                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Resumen**             | Roberto Jiménez valoró positivamente la Landing Page y la Aplicación Web por ser dinámicas, completas e intuitivas. Destacó la claridad en la sección de beneficios, el detalle de los planes de suscripción y el flujo fluido de registro y pago con tarjeta. Consideró práctico el alta y asignación de fisioterapeutas y pacientes, el registro de dispositivos IoT y ejercicios. Como mejora, propuso añadir un indicador visual en el menú de navegación que muestre la sección actual al desplazarse por la página. |
...
| **Sexo**                | Masculino                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Distrito**            | San Miguel                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Ocupación**           | Fisioterapeuta en formación                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| **Timing**              | 01:01:13 - 01:10:49                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                        |
| **Captura**             | ![Captura entrevista Gustavo](assets/images/screenshots/patient-interview-screenshot-4.png)                                                                                                                                                                                                                                                                                                                                                                   |
| **Resumen**             | Gustavo indicó que la Aplicación Web le pareció clara y útil para el seguimiento clínico de pacientes, especialmente porque permite visualizar métricas biomecánicas, alertas de mala ejecución y evolución de ejercicios en un solo lugar. Consideró que el sistema facilitaría la toma de decisiones entre sesiones presenciales. También recomendó incluir confirmaciones claras sobre el estado del dispositivo IoT y la asignación correcta del kit al paciente. |

##### Entrevista 5: Fabián Rojas
...
| **Ocupación**           | Fisioterapeuta clínico                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **Timing**              | 01:17:03 - 01:29:14                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                                                                                                |
| **Captura**             | ![Captura entrevista Diego](assets/images/screenshots/validation-physiotherapist-interview-screenshot-3.png)                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **Resumen**             | Diego indicó que la Aplicación Web le pareció clara e intuitiva, resaltando que el dashboard concentra información necesaria para facilitar la toma de decisiones y la planificación de actividades clínicas. También mencionó que el modo oscuro resulta útil durante largas jornadas frente al computador. Destacó que el registro de pacientes es sencillo, que la interacción con el sistema es fluida y que el flujo para registrar pacientes, crear planificaciones y asignar terapias permite llevar un mejor control del tratamiento. |

---

#### Pacientes

##### Entrevista 7: Gabriel
...
| **Ocupación**           | Estudiante                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Fecha de entrevista** | 2026-06-19                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| **Timing**              | 01:29:15 - 01:38:07                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Video**               | [Ver entrevista](https://upcedupe-my.sharepoint.com/:v:/g/personal/u20201e843_upc_edu_pe/IQD_qlYjDzu1TpK41elo6f88AeXg56UeSNZMFSmreYfYCn8?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJPbmVEcml2ZUZvckJ1c2luZXNzIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXciLCJyZWZlcnJhbFZpZXciOiJNeUZpbGVzTGlua0NvcHkifX0&e=3SzTXh)                                                                                                                                                                                                                                                                                       |
| **Captura**             | ![Captura entrevista Gabriel](assets/images/screenshots/patient-interview-screenshot-1-1.png)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Resumen**             | Gabriel indicó que la aplicación móvil le parece intuitiva y fácil de entender. Comentó que el flujo de acceso, la visualización de ejercicios y la información del sensor son claros para un paciente que necesita seguir una rutina desde casa. También destacó la flexibilidad de la aplicación, ya que permite revisar ejercicios, seguir indicaciones y consultar el progreso sin depender totalmente de una sesión presencial. Como mejora, indicó que le gustaría que se trabajen mejor los estilos visuales, especialmente el contraste entre fondos claros y oscuros, para que la interfaz se vea más consistente y cómoda. |
